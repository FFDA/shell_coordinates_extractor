...
# This script will make a csv file that can be converted to TomTom POI file from table that was extracted from 'company' shell gasstation list.
...
## SLOVENIA ##
# It's not possible to find Slovenia's shell gas stations using google search.
# This function take shell_website as an argument in csv file it will still compare date from shell_website and csv file.
# It's only 7 websites. I found website by hand.
...
with open("Shell_Slovenia_2020.csv", mode="r") as csv_file:
